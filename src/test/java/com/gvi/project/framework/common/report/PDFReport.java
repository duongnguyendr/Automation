package com.gvi.project.framework.common.report;
...
public class PDFReport {
    private static Logger logger = Logger.getLogger(PDFReport.class.getSimpleName());
    ...
    public void toExecute(File sPdfReports, String timeStamp, ReportResult reportResult){
        try {
    ...
    private static void addTitlePageCucumberPDF(Document document, String timeStamp, ReportResult reportResult) throws DocumentException, IOException {
        ...
        try {
            ...
            logger.info("Unable to add Tile page for PDF file: "+ e.getMessage());
        }
