...
public class ByExtJsComponentQuery extends By
{
    ...
    public ByExtJsComponentQuery(WebDriver webDriver)
    {
        this.jse = (JavascriptExecutor) webDriver;
        this.query = null;
    }

    public ByExtJsComponentQuery(WebDriver webDriver, String query)
    {
        this.jse = (JavascriptExecutor) webDriver;
        this.query = query;
    }

    public ByExtJsComponentQuery(JavascriptExecutor jse, String query)
    {
        this.jse = jse;
        this.query = query;
    }
